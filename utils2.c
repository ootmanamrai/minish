...
/*   Updated: 2023/08/16 22:43:01 by otamrani         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_expend(char *s, t_list **lst)
{
	int		i;
	char	*c;
	char	*ex;
	...
	ft_lstadd_back(lst, ft_lstnew(all, 0));
	if ((*lst)->token == 1)
